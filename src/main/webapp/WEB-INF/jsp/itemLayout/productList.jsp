...
<%@ taglib prefix="sc" uri="/demo-store"%>

<c:set var="broadleafCommerceRequestState" value="${requestScope['org.broadleafcommerce.core.web.BroadleafCommerceRequestState']}" />
