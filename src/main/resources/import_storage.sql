-- This file is used to auto-populate the embedded asset storage database for the demo. Hibernate will look for a file called
-- import_storage.sql in the root of the classpath whenever the hibernate.hbm2ddl.auto property is set to create or create-drop.
