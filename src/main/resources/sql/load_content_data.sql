...
INSERT INTO BLC_SC (SC_ID, ARCHIVED_FLAG, CREATED_BY, DATE_CREATED, DATE_UPDATED, UPDATED_BY, CONTENT_NAME, DELETED_FLAG, OFFLINE_FLAG, PRIORITY, LOCALE_CODE, SC_TYPE_ID) VALUES (103, FALSE, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 1, 'Saeco Banner Ad - Members Only', FALSE, FALSE, 1, 'en', 1);
INSERT INTO BLC_SC (SC_ID, ARCHIVED_FLAG, CREATED_BY, DATE_CREATED, DATE_UPDATED, UPDATED_BY, CONTENT_NAME, DELETED_FLAG, OFFLINE_FLAG, PRIORITY, LOCALE_CODE, SC_TYPE_ID) VALUES (104, FALSE, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 1, 'Tuesday Special 50% off Coffee', FALSE, FALSE, 1, 'en', 2);
INSERT INTO BLC_SC (SC_ID, ARCHIVED_FLAG, CREATED_BY, DATE_CREATED, DATE_UPDATED, UPDATED_BY, CONTENT_NAME, DELETED_FLAG, OFFLINE_FLAG, PRIORITY, LOCALE_CODE, SC_TYPE_ID) VALUES (105, FALSE, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 1, 'Buy Grinder get free coffee', FALSE, FALSE, 6, 'en', 2);


-- Structured Content Field
INSERT INTO BLC_SC_FLD (SC_FLD_ID, DATE_CREATED, FLD_KEY, CREATED_BY, SC_ID, VALUE) VALUES (1, CURRENT_TIMESTAMP, 'imageUrl', 1, 100, '/broadleafdemo/images/promos/mainPromo1.gif');
INSERT INTO BLC_SC_FLD (SC_FLD_ID, DATE_CREATED, FLD_KEY, CREATED_BY, SC_ID, VALUE) VALUES (2, CURRENT_TIMESTAMP, 'targetUrl', 1, 100, '/broadleafdemo/store/equipment/espresso?productId=180')
INSERT INTO BLC_SC_FLD (SC_FLD_ID, DATE_CREATED, FLD_KEY, CREATED_BY, SC_ID, VALUE) VALUES (3, CURRENT_TIMESTAMP, 'imageUrl', 1, 101, '/broadleafdemo/images/promos/sidePromo1.jpg');
INSERT INTO BLC_SC_FLD (SC_FLD_ID, DATE_CREATED, FLD_KEY, CREATED_BY, SC_ID, VALUE) VALUES (4, CURRENT_TIMESTAMP, 'targetUrl', 1, 101, '/broadleafdemo/store/equipment/cups')
INSERT INTO BLC_SC_FLD (SC_FLD_ID, DATE_CREATED, FLD_KEY, CREATED_BY, SC_ID, VALUE) VALUES (5, CURRENT_TIMESTAMP, 'imageUrl', 1, 102, '/broadleafdemo/images/promos/sidePromo2.jpg');
INSERT INTO BLC_SC_FLD (SC_FLD_ID, DATE_CREATED, FLD_KEY, CREATED_BY, SC_ID, VALUE) VALUES (6, CURRENT_TIMESTAMP, 'targetUrl', 1, 102, '/broadleafdemo/store/coffee/starbucks?productId=123');
INSERT INTO BLC_SC_FLD (SC_FLD_ID, DATE_CREATED, FLD_KEY, CREATED_BY, SC_ID, VALUE) VALUES (7, CURRENT_TIMESTAMP, 'imageUrl', 1, 103, '/broadleafdemo/images/promos/mainPromo2.jpg');
INSERT INTO BLC_SC_FLD (SC_FLD_ID, DATE_CREATED, FLD_KEY, CREATED_BY, SC_ID, VALUE) VALUES (8, CURRENT_TIMESTAMP, 'targetUrl', 1, 103, '/broadleafdemo/store/equipment/espresso?productId=164')
INSERT INTO BLC_SC_FLD (SC_FLD_ID, DATE_CREATED, FLD_KEY, CREATED_BY, SC_ID, VALUE) VALUES (9, CURRENT_TIMESTAMP, 'imageUrl', 1, 104, '/broadleafdemo/images/promos/sidePromo3.jpg');
INSERT INTO BLC_SC_FLD (SC_FLD_ID, DATE_CREATED, FLD_KEY, CREATED_BY, SC_ID, VALUE) VALUES (10, CURRENT_TIMESTAMP, 'targetUrl', 1, 104, '/broadleafdemo/store/equipment/coffee')
INSERT INTO BLC_SC_FLD (SC_FLD_ID, DATE_CREATED, FLD_KEY, CREATED_BY, SC_ID, VALUE) VALUES (11, CURRENT_TIMESTAMP, 'imageUrl', 1, 105, '/broadleafdemo/images/promos/sidePromo4.jpg');
INSERT INTO BLC_SC_FLD (SC_FLD_ID, DATE_CREATED, FLD_KEY, CREATED_BY, SC_ID, VALUE) VALUES (12, CURRENT_TIMESTAMP, 'targetUrl', 1, 105, '/broadleafdemo/store/equipment/grinders');
...
INSERT INTO BLC_SC_FLD_MAP (SC_ID, SC_FLD_ID, MAP_KEY) VALUES (104, 9, 'imageUrl');
INSERT INTO BLC_SC_FLD_MAP (SC_ID, SC_FLD_ID, MAP_KEY) VALUES (104, 10, 'targetUrl');
INSERT INTO BLC_SC_FLD_MAP (SC_ID, SC_FLD_ID, MAP_KEY) VALUES (105, 11, 'imageUrl');
INSERT INTO BLC_SC_FLD_MAP (SC_ID, SC_FLD_ID, MAP_KEY) VALUES (105, 12, 'targetUrl');

-- Structured Content Rule Field
INSERT INTO BLC_SC_RULE (SC_RULE_ID, MATCH_RULE) VALUES (1, 'customer.registered==true');
INSERT INTO BLC_SC_RULE (SC_RULE_ID, MATCH_RULE) VALUES (2, 'time.dayOfWeek.toString()=="3"');

-- Structured Content Rule Field Map
INSERT INTO BLC_SC_RULE_MAP(BLC_SC_SC_ID, SC_RULE_ID, MAP_KEY) VALUES (103, 1, 'CUSTOMER');
INSERT INTO BLC_SC_RULE_MAP(BLC_SC_SC_ID, SC_RULE_ID, MAP_KEY) VALUES (104, 2, 'TIME');
